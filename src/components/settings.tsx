          ...
          <div className="my-24">
            ...
            <div>
              ...
              <Link
                ...
                label="aquí"
              />. La clave API de OpenAI no es necesario, funciona con OpenRouter que es una alternativa a la API de OpenRouter, puedes introducir la API de OpenRouter para tener un acceso personalizado, sin la API de OpenRouter, es posible que te arroje un error al enviar un mensaje.
            </div>
          </div>
          <div className="my-24">
