          ...
          <div className="my-24">
            ...
            <div>
              ...
              <Link
                ...
                label="aquí"
              />. La clave API de OpenAI no es necesario, funciona con OpenRouter que es una alternativa a la API de OpenAI, puedes introducir la API de OpenRouter para tener un acceso personalizado, sin la API de OpenRouter, es posible que te arroje un error o el personaje no podra responderte al enviar un mensaje.
            </div>
          </div>
          <div className="my-24">
            ...
            ></input>
            <div>
              Sin la API de ElevenLabs, el personaje no podrá hablar, solo hace expresiones de la cara, puedes obtener la API de ElevenLabs &nbsp;
              <Link
