      ...
      <div className="max-h-full overflow-auto">
        <div className="text-text1 max-w-3xl mx-auto px-24 py-64 ">
          ...
          <div className="my-24">
            ...
            <input
              type="text"
              placeholder="API de OpenRouter"
              value={openRouterKey}
              onChange={onChangeOpenRouterKey}
              className="my-4 px-16 py-8 w-full h-40 bg-surface3 hover:bg-surface3-hover rounded-4 text-ellipsis"
            ></input>
            <div>
              Puedes obtener la API de OpenRouter&nbsp;
              <Link
                url="https://openrouter.ai/settings/keys"
                label="aquí"
              />. La clave API de OpenAI no es necesario, funciona con OpenRouter que es una alternativa a la API de OpenAI, puedes introducir la API de OpenRouter para que el personaje pueda responderte, sin la API de OpenRouter, es posible que te arroje un error o el personaje no podrá responderte al enviar un mensaje.
            </div>
          </div>
          <div className="my-24">
            ...
            <input
              type="text"
              placeholder="API de ElevenLabs"
              value={elevenLabsKey}
              onChange={onChangeElevenLabsKey}
              className="my-4 px-16 py-8 w-full h-40 bg-surface3 hover:bg-surface3-hover rounded-4 text-ellipsis"
            ></input>
            <div>
              Sin la API de ElevenLabs, el personaje no podrá hablar, sólo puede hacer expresiones de  la cara, puedes obtener la API de ElevenLabs&nbsp;
              <Link
          ...
          <div className="my-40">
            ...
            <div className="my-16">
              Acá aparecerán las voces guardadas en tu biblioteca, incluyendo las voces preestablecidas:
            </div>
            <div className="my-8">
          ...
          <div className="my-40">
            <div className="my-16 typography-20 font-bold">
              Modelo del personaje VRM, puedes descargar modelos .vrm personalizados en la página https://hub.vroid.com
            </div>
            <div className="my-8">
              <TextButton onClick={onClickOpenVrmFile}>Cargar archivo .vrm</TextButton>
            </div>
          </div>
          <div className="my-40">
            <div className="my-8">
              <div className="my-16 typography-20 font-bold">
                Personalidad (Indicador del sistema)
              </div>
              <TextButton onClick={onClickResetSystemPrompt}>
                Reiniciar la personalidad
              </TextButton>
            </div>
          ...
          <div className="my-40">
            ...
            <div className="my-16">Puedes cambiar el fondo aquí:</div>
            <div className="my-8 flex flex-col gap-4">
              ...
              {backgroundImage && (
                <div className="flex flex-col gap-4">
                  <div className="my-8">
                    <img
                      src={backgroundImage}
                      alt="Previsualización del fondo"
              ...
              <div className="text-sm text-gray-600">
                El fondo de pantalla se guardará y quedará almacenado en la página web.
              </div>
            </div>
          </div>
            ...
            <div className="my-40">
              <div className="my-8 grid-cols-2">
                ...
                <TextButton onClick={onClickResetChatLog}>
                  Eliminar todo el historial de conversación
                </TextButton>
              </div>
              <div className="my-8">
